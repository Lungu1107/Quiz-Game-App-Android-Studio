...
import com.example.androidappvictor.mode.QuestionDifficultMode;
import com.example.androidappvictor.others.ProfileActivity;
import com.example.androidappvictor.others.RewardActivity;

import java.util.List;

public class DifficultModeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<QuestionDifficultMode.Question> questions;
    private QuestionDifficultMode.Question currentQuestion;
    private int score = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_difficult_mode);
        ...
        questions = QuestionDifficultMode.getRandomQuestions();
        loadNewQuestion();
    }
    ...
    private void finishQuiz() {
        Intent intent = new Intent(DifficultModeActivity.this, RewardActivity.class);
    ...
    private void exitQuiz() {
        ...
        Intent intent = new Intent(DifficultModeActivity.this, ProfileActivity.class);
        startActivity(intent);
